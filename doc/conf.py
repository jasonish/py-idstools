...
latex_documents = [
  ('index', 'idstools.tex', u'idstools Documentation',
   u'Jason Ish', 'manual'),
]
...
texinfo_documents = [
  ('index', 'idstools', u'idstools Documentation',
   u'Jason Ish', 'idstools', 'One line description of project.',
   'Miscellaneous'),
]
